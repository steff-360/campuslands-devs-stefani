...
## Que es
Indices es una funcionalidad de MySQL relacionada con estructuras para acelerar busquedas y ordenamientos. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en catalogo de peliculas de miedo. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Indices` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Indices, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-005/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Indices`, con scripts SQL y explicacion clara.
