# Funcionalidad 001 - Motor InnoDB
...
## Que es
Motor InnoDB es una funcionalidad de MySQL relacionada con transacciones, claves foraneas y bloqueo por filas. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en kickboxing. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Motor InnoDB` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Motor InnoDB, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-001/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Motor InnoDB`, con scripts SQL y explicacion clara.
