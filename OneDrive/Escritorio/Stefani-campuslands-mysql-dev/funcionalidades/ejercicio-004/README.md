# Funcionalidad 004 - AUTO_INCREMENT
...
## Que es
AUTO_INCREMENT es una funcionalidad de MySQL relacionada con identificadores secuenciales controlados por MySQL. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en playlist musical. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `AUTO_INCREMENT` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender AUTO_INCREMENT, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-004/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `AUTO_INCREMENT`, con scripts SQL y explicacion clara.
