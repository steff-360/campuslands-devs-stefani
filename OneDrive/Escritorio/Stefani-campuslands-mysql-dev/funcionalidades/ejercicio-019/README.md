# Funcionalidad 019 - Backup y restore
...
## Que es
Backup y restore es una funcionalidad de MySQL relacionada con mysqldump y recuperacion de bases de datos. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en videojuego de accion y aventura. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Backup y restore` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Backup y restore, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-019/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Backup y restore`, con scripts SQL y explicacion clara.
