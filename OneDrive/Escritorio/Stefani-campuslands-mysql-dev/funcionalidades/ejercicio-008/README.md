# Funcionalidad 008 - Subconsultas
...
## Que es
Subconsultas es una funcionalidad de MySQL relacionada con consultas dentro de consultas para filtros y calculos. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en restaurante de comida urbana. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Subconsultas` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Subconsultas, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-008/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Subconsultas`, con scripts SQL y explicacion clara.
