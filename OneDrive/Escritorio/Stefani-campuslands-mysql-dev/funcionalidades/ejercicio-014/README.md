...
## Que es
Triggers es una funcionalidad de MySQL relacionada con acciones automaticas ante INSERT, UPDATE o DELETE. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en animacion 3D. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Triggers` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Triggers, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-014/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Triggers`, con scripts SQL y explicacion clara.
