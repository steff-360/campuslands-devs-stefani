# Funcionalidad 010 - Window Functions
...
## Que es
Window Functions es una funcionalidad de MySQL relacionada con rankings, acumulados y comparaciones por particion. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en viajes y turismo. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Window Functions` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Window Functions, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-010/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Window Functions`, con scripts SQL y explicacion clara.
