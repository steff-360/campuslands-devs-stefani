# Funcionalidad 015 - Transacciones
...
## Que es
Transacciones es una funcionalidad de MySQL relacionada con COMMIT y ROLLBACK para proteger operaciones multiples. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en arquitectura 3D. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Transacciones` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Transacciones, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-015/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Transacciones`, con scripts SQL y explicacion clara.
