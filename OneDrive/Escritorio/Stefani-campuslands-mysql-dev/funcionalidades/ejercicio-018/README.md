# Funcionalidad 018 - Roles y permisos
...
## Que es
Roles y permisos es una funcionalidad de MySQL relacionada con control de acceso con usuarios y privilegios. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en videojuego RPG. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Roles y permisos` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Roles y permisos, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-018/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Roles y permisos`, con scripts SQL y explicacion clara.
