# Funcionalidad 012 - Procedimientos almacenados
...
## Que es
Procedimientos almacenados es una funcionalidad de MySQL relacionada con rutinas SQL reutilizables con parametros. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en estudio de tatuajes. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Procedimientos almacenados` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Procedimientos almacenados, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-012/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Procedimientos almacenados`, con scripts SQL y explicacion clara.
