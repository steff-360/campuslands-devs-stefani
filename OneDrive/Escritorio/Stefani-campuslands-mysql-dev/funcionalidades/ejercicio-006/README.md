...
## Que es
EXPLAIN es una funcionalidad de MySQL relacionada con lectura del plan de ejecucion de una consulta. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en saga de ciencia ficcion. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `EXPLAIN` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender EXPLAIN, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-006/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `EXPLAIN`, con scripts SQL y explicacion clara.
