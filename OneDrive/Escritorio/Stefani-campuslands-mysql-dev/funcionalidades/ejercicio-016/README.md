...
## Que es
JSON es una funcionalidad de MySQL relacionada con almacenamiento y consulta de atributos semiestructurados. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en soldadura. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `JSON` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender JSON, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-016/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `JSON`, con scripts SQL y explicacion clara.
