# Funcionalidad 017 - Full Text Search

## Dificultad
Funcionalidad MySQL aplicada

## Tematica usada
laboratorio de formulas quimicas

## Que es
Full Text Search es una funcionalidad de MySQL relacionada con busqueda textual optimizada en columnas de texto. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en laboratorio de formulas quimicas. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Full Text Search` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Full Text Search, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-017/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Full Text Search`, con scripts SQL y explicacion clara.
