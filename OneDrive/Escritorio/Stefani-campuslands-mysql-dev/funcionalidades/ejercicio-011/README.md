...
## Que es
Vistas es una funcionalidad de MySQL relacionada con consultas guardadas para reportes reutilizables. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en paracaidismo. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Vistas` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Vistas, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-011/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Vistas`, con scripts SQL y explicacion clara.
