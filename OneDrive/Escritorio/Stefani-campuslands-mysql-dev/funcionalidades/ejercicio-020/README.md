# Funcionalidad 020 - Eventos programados
...
## Que es
Eventos programados es una funcionalidad de MySQL relacionada con tareas automaticas con Event Scheduler. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en academia tech. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Eventos programados` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Eventos programados, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-020/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Eventos programados`, con scripts SQL y explicacion clara.
