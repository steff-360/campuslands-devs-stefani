...
## Que es
CTE es una funcionalidad de MySQL relacionada con WITH para organizar consultas complejas. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en tienda de ropa. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `CTE` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender CTE, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-009/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `CTE`, con scripts SQL y explicacion clara.
