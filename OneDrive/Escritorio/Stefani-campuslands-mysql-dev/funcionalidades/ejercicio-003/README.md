# Funcionalidad 003 - Restricciones
...
## Que es
Restricciones es una funcionalidad de MySQL relacionada con PRIMARY KEY, FOREIGN KEY, UNIQUE, NOT NULL, CHECK y DEFAULT. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en pingpong. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `Restricciones` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender Restricciones, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-003/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `Restricciones`, con scripts SQL y explicacion clara.
