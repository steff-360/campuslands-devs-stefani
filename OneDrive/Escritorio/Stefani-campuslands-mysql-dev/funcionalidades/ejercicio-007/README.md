...
## Que es
JOINs es una funcionalidad de MySQL relacionada con combinacion de datos entre tablas relacionadas. Permite resolver problemas reales de almacenamiento, consulta, integridad, rendimiento o automatizacion dentro de una base de datos relacional.
...
Vas a crear un caso practico inspirado en biblioteca gamer. Debes construir una mini base de datos o adaptar la plantilla para demostrar la funcionalidad `JOINs` con un ejemplo que pueda ejecutarse y explicarse.

## Objetivo
Comprender JOINs, aplicarlo en un escenario realista y documentar que cambio produce sobre los datos o consultas.
...
- Trabaja dentro de `funcionalidades/ejercicio-007/resoluciones/nombre-apellido/`.
...
## Entregable esperado
Una demostracion pequena pero completa de `JOINs`, con scripts SQL y explicacion clara.
