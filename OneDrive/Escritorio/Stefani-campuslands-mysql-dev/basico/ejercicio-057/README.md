# Ejercicio 057 - modelado de entidad para videojuego de accion y aventura
...
## Objetivo
Practicar modelado de entidad en MySQL creando una solucion que pueda ejecutarse desde cero y que demuestre analisis, orden y criterio tecnico.
...
```text
basico/ejercicio-057/resoluciones/juan-perez/
├── README.md
├── ddl/schema.sql
├── dml/inserts.sql
└── dql/consultas.sql
