# Ejercicio 055 - COUNT y SUM para laboratorio de formulas quimicas
...
Una academia tecnica esta construyendo un modulo de datos inspirado en laboratorio de formulas quimicas. El objetivo es guardar informacion ordenada, consultar indicadores utiles y dejar scripts SQL faciles de revisar por otro desarrollador.
...
## Objetivo
Practicar COUNT y SUM en MySQL creando una solucion que pueda ejecutarse desde cero y que demuestre analisis, orden y criterio tecnico.
...
```text
basico/ejercicio-055/resoluciones/juan-perez/
├── README.md
├── ddl/schema.sql
├── dml/inserts.sql
└── dql/consultas.sql
