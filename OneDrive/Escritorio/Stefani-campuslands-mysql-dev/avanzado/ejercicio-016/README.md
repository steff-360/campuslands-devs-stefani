...
Una academia tecnica esta construyendo un modulo de datos inspirado en restaurante de comida urbana. El objetivo es guardar informacion ordenada, consultar indicadores utiles y dejar scripts SQL faciles de revisar por otro desarrollador.
...
## Objetivo
Practicar transacciones en MySQL creando una solucion que pueda ejecutarse desde cero y que demuestre analisis, orden y criterio tecnico.
...
```text
avanzado/ejercicio-016/resoluciones/juan-perez/
├── README.md
├── ddl/schema.sql
├── dml/inserts.sql
└── dql/consultas.sql
