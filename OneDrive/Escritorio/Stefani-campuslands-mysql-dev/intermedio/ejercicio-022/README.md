...
Una academia tecnica esta construyendo un modulo de datos inspirado en animacion 3D. El objetivo es guardar informacion ordenada, consultar indicadores utiles y dejar scripts SQL faciles de revisar por otro desarrollador.
...
```text
intermedio/ejercicio-022/resoluciones/juan-perez/
├── README.md
├── ddl/schema.sql
├── dml/inserts.sql
└── dql/consultas.sql
