# Ejercicio 057 - consultas de reportes para videojuego de accion y aventura
...
## Objetivo
Practicar consultas de reportes en MySQL creando una solucion que pueda ejecutarse desde cero y que demuestre analisis, orden y criterio tecnico.
...
```text
intermedio/ejercicio-057/resoluciones/juan-perez/
├── README.md
├── ddl/schema.sql
├── dml/inserts.sql
└── dql/consultas.sql
