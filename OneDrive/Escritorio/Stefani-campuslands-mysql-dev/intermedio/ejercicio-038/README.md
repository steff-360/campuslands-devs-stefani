...
Una academia tecnica esta construyendo un modulo de datos inspirado en futbol sala. El objetivo es guardar informacion ordenada, consultar indicadores utiles y dejar scripts SQL faciles de revisar por otro desarrollador.
...
```text
intermedio/ejercicio-038/resoluciones/juan-perez/
├── README.md
├── ddl/schema.sql
├── dml/inserts.sql
└── dql/consultas.sql
